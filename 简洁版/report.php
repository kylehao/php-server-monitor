 ...
 *       本文件需要与 index.php 中的 $TOKENS 数组保持一致。
 * ==========================================
 */
...
// ---------- 数据库路径 ----------
$DB_FILE = __DIR__ . "/data/status_v2_bcisqfv3qi3wtt3n6gyhp3eu03o6ahph.db";
 ...
 * 👤 用户配置区
 * ==========================================
 * 请将下面的 token 原文替换为你自己的，key 为 token 原文，value 为显示名称。
 * 注意：这里的 token 原文必须和客户端 /opt/hyruo/env 中的 TOKEN 完全相同！
 */
$TOKENS = [
    "KC4PHT8POCUZT6IP9QTH0SK8VA3C4PUA" => "Oracle ARM Singapore",
	"1MX1YWBRZ0DM2BDYLQDTNXUMROPJTLK4" => "Oracle ARM Hyderabad",
	"VWHEVK3OWA1VH2VX5SNYTI38094WDPT6" => "Oracle AMD Hyderabad",
	"W9QPP9JU5KOQLNT4CQJ2HCSGWRB07NMM" => "Oracle AMD Sanjose",
	"FHTPKD5WIEFY4JCR5KNIA3H8MQ6M9RV5" => "HomeCloud",
];
// ==========================================
